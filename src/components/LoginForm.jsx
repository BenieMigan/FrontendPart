  ...
  return (
    <Card className="w-full max-w-md mx-auto bg-white/95 backdrop-blur-sm shadow-2xl border-0 animate-scale-in">
      <CardHeader className="space-y-3 text-center pb-6">
        <CardTitle className="text-2xl font-bold text-port-navy">Connexion</CardTitle>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="text-center space-y-2">
          <button   onClick={() => navigate('/reset-password')} className="text-port-blue hover:text-port-navy transition-colors text-sm font-medium underline-offset-4 hover:underline">
            Mot de passe oublié ?
          </button>
          <div>
            <span className="text-sm text-port-navy/70">Pas encore de compte ? </span>
            <button
              onClick={() => navigate('/register')} // ✅ Redirection
